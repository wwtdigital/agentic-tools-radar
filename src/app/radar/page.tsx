                    ...
                    <label key={dim} className={`flex items-center gap-2 text-sm ${wouldBeUnderMinimum ? 'cursor-not-allowed' : 'cursor-pointer'}`}>
                      ...
                      {description && (
                        <div className="group/tooltip relative inline-block">
                          ...
                          <div className="absolute bottom-full left-1/2 -translate-x-1/2 mb-2 px-3 py-2 bg-slate-900 text-white text-xs rounded shadow-lg opacity-0 group-hover/tooltip:opacity-100 pointer-events-none transition-opacity duration-200 w-64 z-[100] whitespace-normal">
                            {description}
